...
st.markdown("""
- Tren pesanan dan revenue menunjukkan peningkatan hingga akhir 2017 sebelum mengalami fluktuasi pada periode berikutnya.

- Kategori produk seperti *health_beauty*, *watches_gifts*, dan *bed_bath_table* menjadi kontributor utama revenue.

- Sebagian besar pelanggan memiliki frekuensi pembelian rendah, sedangkan hanya sebagian kecil pelanggan memiliki kontribusi monetary tinggi.

- Filter interaktif memungkinkan eksplorasi performa bisnis secara dinamis berdasarkan waktu dan kategori produk.
""")
